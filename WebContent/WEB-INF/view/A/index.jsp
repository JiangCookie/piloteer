  ...
  <div class="wrap clearfix"> 
    ...
    <div class="item-brand c-item">
      ...
      <div class="brand-wrapper">
        ...
        <a href="#" class="brand-item" target="_blank"><img src="images/55a46160eac22.png" alt="奥迪"><span>奥迪</span></a>
        <a href="#" class="brand-item" target="_blank"><img src="images/55a4613f6aab9.png" alt="奔驰"><span>奔驰</span></a>
        <a href="#" class="brand-item" target="_blank"><img src="images/55c8639f1aa89.png" alt="宝马"><span>宝马</span></a>
        <a href="#" class="brand-item" target="_blank"><img src="images/567a3b2190d9f.png" alt="路虎"><span>路虎</span></a>
        <a href="#" class="brand-item" target="_blank"><img src="images/567a3cdb8bf68.png" alt="保时捷"><span>保时捷</span></a>
        <a href="#" class="brand-item" target="_blank"><img src="images/55a4afc65ed32.png" alt="丰田"><span>丰田</span></a>
        <a href="#" class="brand-item" target="_blank"><img src="images/55a34e9dcd43a.png" alt="大众"><span>大众</span></a> 
        </div>
      </div>
    ...
    <div id="choose_model" class="item-model c-item">
      ...
      <div class="model-wrapper">
        ...
        <div class="model-all clearfix">
          <div class="models-line"><a class="models-item-m">小型</a><a target="_blank" href="#" class="models-item">宝马1系(进口)</a><a target="_blank" href="#" class="models-item">奔驰A级(进口)</a></div>
          <div class="models-line"><a class="models-item-m">轿车</a><a target="_blank" href="#" class="models-item">奥迪A6L</a><a target="_blank" href="#" class="models-item">宝马5系</a><a target="_blank" href="xl1987_pp2.html" class="models-item">奔驰E级</a><a target="_blank" href="xl2593_pp9.html" class="models-item">奥迪A4L</a><a target="_blank" href="xl2364_pp2.html" class="models-item">奔驰C级</a></div>
  ...
  <div class="main-a mDiv" id="box1">
    <div class="wrap">
      ...
      <div class="inBox clearfix">
        <div class="thPic left dInline pve tBox"> <a href="#"  target="_blank"> <img src="images/56b01c412ea24.jpg" class="imgVt" /> <span class="icon icon_hd"></span></a> </div>
        <div class="tBox right pve dInline thPicRight">
          ...
          <div class="pve right dInline hdPic"> <a href="pp96_/ord/sta.html"  target="_blank"> <img src="images/55ed9e88063ae.jpg" class="imgVt" /> <span class="icon icon_hd"></span></a> </div>
        </div>
      </div>
    </div>
  </div>
  <div class="mDiv" id="box2">
    <div class="wrap">
      ...
      <div class="inBox clearfix">
        <div class="tBox left pve dInline thPicRight">
          <div class="thPic1 left dInline pve">
            <ul class="clearfix">
              ...
              <li class="pve liHd"> <a href="Cars/index/channel/2/id/949.html"  target="_blank"> <img src="images/56c56f308b591.jpg" class="imgVt" /> <span class="icon icon_hd"></span></a> </li>
        ...
        <div class="thPic right dInline pve tBox"> <a href="pp2_/ord/sta.html"  target="_blank"> <img src="images/55ed9ec02ac8d.jpg" class="imgVt" /> <span class="icon icon_hd"></span></a> </div>
      </div>
    </div>
  </div>
  <div class="mDiv main-a">
    <div class="wrap">
      ...
      <div class="jpBox">
        ...
        <a class="last"> <img src="images/55a34e9dcd43a.png" width="50" height="38" /> <span>大众</span> <i></i></a> 
        </div>
        <div class="jpCont">
            ...
            <ul class="clearfix">
              <li class="clearfix" style="position: relative;"> 
               <a href="#" target="_blank">
                ...
                <div class="carImg left dInline"> <img src="images/56caabd482cc0.JPG-thumb.JPG" width="266" /> </div>
    ...
    <div class="wrap">
      ...
      <div class="in-news clearfix">
        <div class="new-left dInline left">
          <h3>动态</h3>
          <div class="clearfix">
            <div class="new-dl left dInline"> <a href="#" class='aImg'><img src="images/56ca7a0e6d9c4.jpg"  width='262' height='170' /></a>
              <ul>
            ...
            <div class="new-dl right dInline"> <a href="#" class='aImg'><img src="images/56b0235b6e66e.jpg"  width='262' height='170' /></a>
              <ul>
        ...
        <div class="nKe left dInline">
          ...
          <div class="slide">
            ...
            <div class="bd">
              <ul>
                <li class="clearfix">
                  <div class="bd-dl"> <a href="#" class="aImg"> <img src="images/5631c2b4596bc.jpg" width="242" height="170" /> </a>
                    <h4>当漂移车手  遇见限量A8</h4>
                    <p>今年夏天亿金名车广场的明星车辆、全省唯一一辆橙色奥迪A8L，他的买家是一位身份特殊的勇士，一位知名的专业漂移赛车手，有“河南</p>
                    <div align="right"> <a href="#" class="cMore">查看详情</a> </div>
                  </div>
                  
                  <div class="bd-dl"> <a href="#" class="aImg"> <img src="images/5631c24f293bb.jpg" width="242" height="170" /> </a>
                    <h4>青藏川藏   曲水流觞</h4>
